...
$htmlpath = "upload/announce/file/" . $val[6];
$db->close();
    ...
    <div class="global-container">
        ...
        <section class="layout-container">
            <div class="default-header">
                <div class="wrapper">
                    <div class="container">
                        <div class="title  text-center">ประกาศข่าวสาร</div>
                        <div class="text-center">
                            <a href="index.php" class="link" style="color:white;">หน้าหลัก</a><span style="color:white;"> > ประกาศข่าวสาร</span>
                        </div>
            ...
            <div class="default-page news-page pb-0" style="margin: 2rem 0;">
                <div class="detail-body">
                    <div class="container-xl">
                        ...
                        <?php if (is_file('upload/announce/' . $val[3])) { ?>
                        <div class="gallery-block">
                            <div class="row justify-content-center">
                                <div class="col-md-10">
                                    <div class="ratio ratio-16x9">
                                        <?php if (is_file('upload/announce/' . $val[3])) { ?>
                                            <img src="<?php echo $core_template; ?>upload/announce/<? echo $val[3] ?>" alt="" />
                                        <?php } else { ?>
                                        <?php } ?>
                                    </div>
                                </div>
