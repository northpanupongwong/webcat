        ...
        <div class="container-xl">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav align-items-lg-baseline me-auto mb-2 mb-lg-0">
                    ...
                    <li class="nav-item">
                        <a class="nav-link <?php if ($_SERVER['SCRIPT_NAME'] == "/webcat/announce.php" || $_SERVER['SCRIPT_NAME'] == "/webcat/announce-detail.php" || $_SERVER['SCRIPT_NAME'] == "/webcat/announce-form.php") { ?>  active  <?php   }  ?>" aria-current="page" href="announce.php">ประกาศข่าวสาร</a>
                    </li>
                    <li class="nav-item">
                    ...
                    <li class="nav-item">
                        <a class="nav-link <?php if ($_SERVER['SCRIPT_NAME'] == "/webcat/help.php" || $_SERVER['SCRIPT_NAME'] == "/webcat/help-detail.php" || $_SERVER['SCRIPT_NAME'] == "/webcat/help-form.php") { ?>  active  <?php   }  ?>" aria-current="page" href="help.php">ขอความช่วยเหลือ</a>
                    </li>
                    <li class="nav-item">
