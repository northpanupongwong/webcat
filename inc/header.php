        ...
        <div class="container-xl">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav align-items-lg-baseline me-auto mb-2 mb-lg-0">
                    ...
                    <li class="nav-item">
                        <a class="nav-link <?php if($_SERVER['SCRIPT_NAME']=="/webcat/announce.php" || $_SERVER['SCRIPT_NAME']=="/webcat/announce-detail.php") { ?>  active  <?php   }  ?>" aria-current="page" href="announce.php">ประกาศข่าวสาร</a>
                    </li>
                    <li class="nav-item">
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <?php 
                        if($_SERVER['SCRIPT_NAME']=="/webcat/race-dog.php" || $_SERVER['SCRIPT_NAME']=="/webcat/disease-dog.php" || $_SERVER['SCRIPT_NAME']=="/webcat/race-cat.php" || $_SERVER['SCRIPT_NAME']=="/webcat/disease-cat.php" || $_SERVER['SCRIPT_NAME']=="/webcat/clinic.php"
                        || $_SERVER['SCRIPT_NAME']=="/webcat/race-dog-detail.php" || $_SERVER['SCRIPT_NAME']=="/webcat/disease-dog-detail.php" || $_SERVER['SCRIPT_NAME']=="/webcat/race-cat-detail.php" || $_SERVER['SCRIPT_NAME']=="/webcat/disease-cat-detail.php")  
                        { ?>  active  <?php   }  ?>" 
                        href="#" id="navbarDropdown1" role="button" data-bs-toggle="dropdown" aria-expanded="false">ข้อมูลสัตว์</a>
                        <ul class="dropdown-menu submenu-level-2" aria-labelledby="navbarDropdown1">
                            ...
                            <li><a class="dropdown-item" href="clinic.php">คลินิกรักษาสัตว์</a></li>
                        </ul>
                    </li>

                    <li class="nav-item">
                        <a class="nav-link <?php if($_SERVER['SCRIPT_NAME']=="/webcat/help.php" || $_SERVER['SCRIPT_NAME']=="/webcat/help-detail.php") { ?>  active  <?php   }  ?>" aria-current="page" href="help.php">ขอความช่วยเหลือ</a>
                    </li>
                    <li class="nav-item">
