...
$sql .= " WHERE disease_status = 'Enable' AND disease_kind = 'แมว'";
                ...
                <div class="default-header">
                    <div class="wrapper">
                        <div class="container">
                            ...
                            <div class="text-center txt-desc" style="color: white;line-height: 1.5rem;">ทาสแมวทั้งหลายระวังให้ดี อาการเหล่านี้แสดงถึงความผิดปกติได้! เพราะเจ้าเหมียวไม่สามารถเอ่ยปากบอกได้ว่า กำลังทุกข์ใจกับปัญหาสุขภาพอยู่ 
หน้าที่ของทาสแมวอย่างเรา คือต้องรู้ทันสารพัดโรคร้าย สังเกตพฤติกรรมความผิดปกติ และหาทางรับมือให้ได้อย่างทันท่วงที 
ว่าแต่สารพัดโรคร้ายที่ว่านั้น มีโรคอะไรบ้าง น่ากลัวแค่ไหน และมีวิธีการป้องกันรักษาอย่างไร</div>
                        </div>
                    </div>
                    <figure class="cover">
