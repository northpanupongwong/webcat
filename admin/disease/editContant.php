...
$sql .= " WHERE disease_id = '" . $_REQUEST['selectid'] . "'";
// print_pre($sql);
...
<body class="skin-default-dark fixed-layout">
    <form action="?" method="get" name="myForm" id="myForm" enctype="multipart/form-data">
        ...
        <input name="oldSym[]" type="hidden" id="oldSym" value="<? echo $valSymptom ?>" />
        <!-- ============================================================== -->
                        ...
                        <div class="col-12">
                            <div class="card">
                                ...
                                <div class="card-body px-5">
                                    <div class="row my-3">
                                        <div class="col">
                                            <h4>ชื่อโรค<span class="fontContantAlert">*</span> :</h4>
                                    ...
                                    <div class="row my-3">
                                        <div class="col">
                                            ...
                                            <select onchange="openSelectType('onSelectKind.php');" type="text" name="kind" id="kind" style="width: 100%;height:36px;background-color:#ededed" class="form-control border border-4 rounded">
                                        ...
                                        <div class="col">
                                            ...
                                            <div id="boxChangeType">
                                                <select class="js-example-basic-multiple form-control border border-4 rounded" name="symptom[]" multiple="multiple" style="width: 100%;height:36px;background-color:#ededed">
                                                    ...
                                                    ?>
                                                        <option value="<?php echo $row_catid ?>" <?php if (in_array($row_catid, $valSymptom)) { ?> selected="selected" <?php  } ?>><?php echo $row_catname ?></option>
                                                    <?php  } ?>
                                                </select>
                                            </div>
                                        </div>
    ...
    <script>
        ...
        function uploadFile() {
            ...
            var locationfile = "../../upload/disease/";
