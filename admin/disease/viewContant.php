                            ...
                            <div class="card">
                                ...
                                <div class="card-body px-5">
                                    ...
                                    <div class="row my-3">
                                        <div class="col">
                                            <h4>คำอธิบาย :</h4>
                                            <input disabled value="<?php echo $valTitle ?>" type="text" name="titles" id="titles" style="width: 100%;height:36px;background-color:#ededed" class="form-control border border-4 rounded">
                                        </div>
                                    </div>
                                    <div class="row my-3">
                                        <div class="col">
                                            ...
                                            <select disabled class="js-example-basic-multiple form-control border border-4 rounded" name="symptom[]" multiple="multiple" style="width: 100%;height:36px;background-color:#ededed">
                                                <?php foreach($query2 as $valobject){ ?>
                                                <option value="<?php echo $valobject[0] ?>" selected><?php echo $valobject[1] ?></option>
                                                <?php } ?>
                                            </select>
                                            </div>
                                        </div>
