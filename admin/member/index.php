                ...
                <form action="?" method="post" name="myForm" id="myForm">
                    ...
                    <div class="row page-titles">
                        <div class="col-md-5 align-self-center">
                            <h4 class="text-themecolor">สมาชิก</h4>
                        </div>
                    ...
                    <div class="row">
                        ...
                        <div style="width: 2%;padding:10px;">
                                        ...
                                        <table class="table">
                                            <thead>
                                                <tr>
                                                    ...
                                                    <th width="12%" class="text-center">ชื่อ</th>
                                                    <th width="12%" class="text-center">นามสกุล</th>
                                            ...
                                            <tbody>
                                                ...
                                                if ($search <> "") {
                                                    $sql = $sql . "  WHERE  (
                                                    " . $table . "_username LIKE '%$search%'OR
                                                    " . $table . "_fname LIKE '%$search%' OR
                                                    " . $table . "_lname LIKE '%$search%'
                                                    ) ";
                                                }
                                                ...
                                                ?>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td class="text-center"><?php echo $valFname ?></td>
                                                            <td class="text-center"><?php echo $valLname ?></td>
                                                            <td class="text-center"><?php echo $valEmail ?></td>
