                            ...
                            <div class="card">
                                ...
                                <div class="card-body px-5">
                                    <div class="row my-3">
                                        <div class="col">
                                            <h4>ชื่อผู้ใช้ : </h4>
                                            <input disabled type="text" name="Username" id="Username" value="<?php echo $valName ?>" style="width: 100%;height:36px;background-color:#ededed" class="form-control border border-4 rounded">
                                        </div>
                                    </div>
                                    <div class="row my-3">
                                        <div class="col">
                                            <h4>รหัสผ่าน : </h4>
                                            <input disabled type="text" name="Password" id="Password" value="<?php echo $valPass ?>" style="width: 100%;height:36px;background-color:#ededed" class="form-control border border-4 rounded">
                                        </div>
                                    </div>
                                    <div class="row my-3">
                                        <div class="col">
                                            <h4>ชื่อ : </h4>
                                            <input disabled type="text" name="name" id="name" value="<?php echo $valFname ?>" style="width: 100%;height:36px;background-color:#ededed" class="form-control border border-4 rounded">
                                        </div>
                                    </div>
                                    <div class="row my-3">
                                        <div class="col">
                                            <h4>นามสกุล : </h4>
                                            <input disabled type="text" name="lastname" id="lastname" value="<?php echo $valLname ?>" style="width: 100%;height:36px;background-color:#ededed" class="form-control border border-4 rounded">
                                        </div>
                                    </div>
                                    <div class="row my-3">
                                        <div class="col">
                                            <h4>อีเมล : </h4>
                                            <input disabled type="text" name="email" id="email" value="<?php echo $valEmail ?>" style="width: 100%;height:36px;background-color:#ededed" class="form-control border border-4 rounded">
                                        </div>
                                    </div>
