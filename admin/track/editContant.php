                            ...
                            <div class="card">
                                ...
                                <div class="card-body px-5">
                                    ...
                                    <div class="row my-3">
                                        ...
                                        <div class="col-sm-6">
                                            <h4>สายพันธุ์ :</h4>
                                            <input  value="<?php echo $valGene ?>" type="text" name="gene" style="width: 100%;height:36px;background-color:#ededed" class="form-control border border-4 rounded">
                                        </div>
                                    </div>
                                    <div class="row my-3">
                                        <div class="col">
                                    ...
                                    <div class="row my-3">
                                        <div class="col">
                                            <h4>จุดสังเกตุ :</h4>
                                            <input  value="<?php echo $valSpot ?>" type="text" name="spot" id="spot" style="width: 100%;height:36px;background-color:#ededed" class="form-control border border-4 rounded">
                                        </div>
                                    </div>
                                    <div class="row my-3">
                                        <div class="col">
                                            <h4>บริเวณที่หาย :</h4>
                                            <textarea  type="text" name="area" style="width: 100%;background-color:#ededed" class="form-control border border-4 rounded"><?php echo $valGene ?></textarea>
                                        </div>
                                    </div>
                                    <div class="row my-3">
                                        <div class="col">
