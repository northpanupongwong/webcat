...
$sql .= " WHERE annouce_id = '" . $_REQUEST['selectid'] . "'";
// print_pre($sql);
...
<body class="skin-default-dark fixed-layout">
                            ...
                            <div class="card">
                                ...
                                <div class="card-body px-5">
                                    ...
                                    <div class="row my-3">
                                        <div class="col">
                                            <h4>คำอธิบาย : </h4>
                                            <input type="text" name="titles" id="titles" value="<?php echo $valTitle ?>" style="width: 100%;height:36px;background-color:#ededed" class="form-control border border-4 rounded">
                                        </div>
                                    </div>
                                    <div class="row my-3">
                                        <div class="col">
    ...
    <script>
        ...
        function uploadFile() {
            ...
            var locationfile = "../../upload/announce/";
