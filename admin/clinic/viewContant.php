                            ...
                            <div class="card">
                                ...
                                <div class="card-body px-5">
                                    <div class="row my-3">
                                        <div class="col">
                                            <h4>ชื่อ : </h4>
                                            <input disabled type="text" name="Subject" id="Subject" value="<?php echo $valName ?>" style="width: 100%;height:36px;background-color:#ededed" class="form-control border border-4 rounded">
                                        </div>
                                    </div>
                                    <div class="row my-3">
                                        <div class="col">
                                    ...
                                    <div class="row my-3">
                                        <div class="col">
                                            <h4>จังหวัด : </h4>
                                            <input disabled type="text" name="province" value="<?php echo $valProvince ?>" style="width: 100%;height:36px;background-color:#ededed" class="form-control border border-4 rounded">
                                        </div>
                                    </div>
                                    <div class="row my-3">
                                        <div class="col-sm-6">
                                            <h4>เวลาทำการ : </h4>
                                            <input disabled type="text" name="OpenTime" value="<?php echo $valOpen ?>" style="width: 100%;height:36px;background-color:#ededed" class="form-control border border-4 rounded">
                                        </div>
                                        <div class="col-sm-6">
                                            <h4>เบอร์โทร : </h4>
                                            <input disabled type="text" name="Tel" value="<?php echo $valTel ?>" style="width: 100%;height:36px;background-color:#ededed" class="form-control border border-4 rounded">
                                        </div>
                                    </div>
                                    <div class="row my-3">
                                        <div class="col">
                                            <h4>ที่อยู่ของคลินิก : </h4>
                                            <textarea disabled type="text" name="Address" style="width: 100%;background-color:#ededed" class="form-control border border-4 rounded"><?php echo $valAdress ?></textarea>
                                        </div>
                                    </div>
                                    <div class="row my-3">
                                        <div class="col">
