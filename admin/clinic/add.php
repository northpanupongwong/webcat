                            ...
                            <div class="card">
                                ...
                                <div class="card-body px-5">
                                    ...
                                    <div class="row my-3">
                                        <div class="col-sm-6">
                                            <h4>เวลาทำการ :</h4>
                                            <input type="text" name="OpenTime" style="width: 100%;height:36px;background-color:#ededed" class="form-control border border-4 rounded">
                                        </div>
                                        <div class="col-sm-6">
                                            <h4>เบอร์โทร :</h4>
                                            <input type="text" name="Tel" style="width: 100%;height:36px;background-color:#ededed" class="form-control border border-4 rounded">
                                        </div>
                                    </div>
                                    <div class="row my-3">
                                        <div class="col">
                                            <h4>ที่อยู่ของคลินิก :</h4>
                                            <textarea type="text" name="Address" style="width: 100%;background-color:#ededed" class="form-control border border-4 rounded"></textarea>
                                        </div>
                                    </div>
                                    <div class="row my-3">
                                        <div class="col">
