...
$sql .= " WHERE disease_status = 'Enable' AND disease_kind = 'สุนัข'";
        ...
        <section class="layout-container ">
            <form action="?" method="post" name="myForm" id="myForm">
                ...
                <div class="default-header">
                    <div class="wrapper">
                        <div class="container">
                            <div class="title  text-center">โรคภัยที่พบได้ในสุนัข</div>
                            <div class="text-center txt-desc" style="color: white;line-height: 1.5rem;">โรคต่างๆในสุนัขแก่ที่เจ้าของอาจจะต้องพบเจอ แต่ไม่รู้จะจัดการอย่างไร อาการป่วยต่างๆเหล่านี้เป็นอาการหรือโรคที่สามารถพบเจอได้เมื่อสุนัขอายุเยอะขึ้น เช่น อาการหายใจแรง
 หอบหืด หรือ อาการกล้ามเนื้ออ่อนแรงต่างๆ สุดท้ายก็จะส่งผลไปถึงเรื่อง ไม่ยอมกินอาหาร ไม่ยอมขยับตัว และไม่ยอมเข้าสังคม </div>
                        </div>
                    </div>
                    <figure class="cover">
                                                    ...
                                                    <div class="row align-items-center">
                                                        <div class="col-auto">
                                                            <?php if (is_file('upload/disease/' . $Key[4])) { ?>
                                                                <img style="height:300px;width:320px" src="<?php echo $core_template; ?>upload/disease/<?php echo $Key[4] ?>" class="width-90 rounded-3" alt="">
                                                            <?php } else { ?>
                                                        ...
                                                        <div class="col" style="height:300px;width:320px">
                                                            <div class="overflow-hidden flex-nowrap">
                                                                ...
                                                                <button type="button" onclick="location.href='disease-cat-detail.php?id=<?php echo $Key[0] ?>'" class="btn" style="position: absolute;right:    10px;bottom:   10px;">
                                                                อ่านต่อ..
                                                            </button>
                                                            </div>
                                                        </div>
