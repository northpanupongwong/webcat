                ...
                <div class="default-header">
                    <div class="wrapper">
                        <div class="container">
                            ...
                            <div class="text-center txt-desc" style="color: white;line-height: 1.5rem;"> หมา หรือคำสุภาพว่า สุนัข (ชื่อวิทยาศาสตร์: Canis familiaris หรือ Canis lupus familiaris) เป็นลูกหลานหมาป่าที่ปรับตัวเป็นสัตว์เลี้ยงที่มักชูหางขึ้นสูง หมาสืบสายพันธุ์จากหมาป่าโบราณที่สูญพันธ์แล้ว และญาติใกล้ชิดกับหมาที่สุดที่ยังมีชีวิตอยู่คือหมาป่าสมัยใหม่ หมาเป็นสัตว์สปีชีส์แรกที่ถูกปรับเป็นสัตว์เลี้ยง ให้กับคนเก็บของป่าล่าสัตว์เมื่อมากกว่า 15,000 ปีก่อน ซึ่งอยู่ก่อนหน้าการพัฒนาด้านเกษตรกรรม
เนื่องจากมีส่วนเกี่ยวข้องกับมนุษย์เป็นเวลายาวนาน ทำให้หมากลายเป็นสัตว์เลี้ยงของคนจำนวนมาก มีอิทธิพลต่อสังคมมนุษย์จนทำให้มันได้รับฉายา "เพื่อนที่ดีที่สุดของมนุษย์"</div>
                        </div>
                    </div>
                    <figure class="cover">
                        <img class="img-cover" src="<?php echo $core_template; ?>assets/img/background/bg6.png" alt="bg-home">
                    </figure>
                                                    ...
                                                    <div class="row align-items-center">
                                                        ...
                                                        <div class="col" style="height:300px;width:320px">
                                                            <div class="overflow-hidden flex-nowrap">
                                                                ...
                                                                <button type="button" onclick="location.href='race-dog-detail.php?id=<?php echo $Key[0] ?>'" class="btn" style="position: absolute;right:    10px;bottom:   10px;">
                                                                อ่านต่อ..
                                                            </button>
                                                            </div>
                                                        </div>
